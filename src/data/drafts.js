...
var drafts_object = { title: "Drafts", value: 1, amount: INDIA_DAO_CHITTY + INDIA_DAO_MONISH + IMMUNEFI_BUG_BOUNTY + EUROPE_DAO + ASIA_DAO, color: pending_drafts_celo_color,label:'', approved:0, draft: true, type: "Drafts" }


//6. Add Initiative to drafts array
var drafts = [  india_dao_chitty, india_dao_monish, immunefi_bug_bounty, europe_dao, asia_dao ]
