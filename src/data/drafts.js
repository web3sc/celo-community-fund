...
var drafts_object = { title: "Drafts", value: 1, amount: INDIA_DAO_CHITTY + INDIA_DAO_MONISH + AFRICA_DAO + IMMUNEFI_BUG_BOUNTY + PREZENTI_SECOND_ROUND, color: pending_drafts_celo_color,label:'', approved:0, draft: true }


//6. Add Initiative to drafts array
var drafts = [  india_dao_chitty, india_dao_monish, africa_dao, latam_dao, immunefi_bug_bounty, prezenti_second_round  ]
