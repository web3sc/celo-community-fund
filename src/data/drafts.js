...
const EUROPE_DAO = 440000;
const ASIA_DAO = 1280000;
const CREATIVE_COMMUNITY = 215808;
...
const europe_dao_proposal = "https://github.com/celo-org/governance/blob/main/CGPs/cgp-0082.md"
const asia_dao_proposal = "https://forum.celo.org/t/celo-asia-dao-proposal/5957"
const creatives_community_proposal = "https://github.com/celo-org/governance/pull/279/files"
...
var europe_dao = { title: "Europe DAO", value: EUROPE_DAO, color: pending_drafts_celo_color,label:'', approved:0, proposal: europe_dao_proposal, draft: true}

var asia_dao = { title: "Asia DAO", value: ASIA_DAO, color: pending_drafts_celo_color,label:'', approved:0, proposal: asia_dao_proposal, draft: true}

var creative_community = { title: "Creative Community", value: CREATIVE_COMMUNITY, color: pending_drafts_celo_color,label:'', approved:0, proposal: creatives_community_proposal, draft: true}
...
var drafts_object = { title: "Drafts", value: 1, amount: INDIA_DAO_CHITTY + INDIA_DAO_MONISH + IMMUNEFI_BUG_BOUNTY + EUROPE_DAO + ASIA_DAO + CREATIVE_COMMUNITY, color: pending_drafts_celo_color,label:'', approved:0, draft: true, type: "Drafts" }


//6. Add Initiative to drafts array
var drafts = [  india_dao_chitty, india_dao_monish, immunefi_bug_bounty, europe_dao, asia_dao, creative_community ]
